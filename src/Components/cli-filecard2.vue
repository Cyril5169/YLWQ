    ...
    <div class="content">
        ...
        <div class="fliesRight">
            ...
            <div class="content-wrapper">
                   ...
                   <input type="text" name="xEmail" v-model="xEmail" :readOnly='only' :class="{readOnly:only}">
            </div>
            <div class="content-wrapper">
                   <p class="title">邮编</p>
                   <input type="text" name="xZipCpde" v-model="xZipCode" :readOnly='only' :class="{readOnly:only}">
            </div>
        </div>
    </div>
    <div class="button">
