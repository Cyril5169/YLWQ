    ...
    <div class="right">
      ...
      <div class="picture">
        ...
        <div class="avatar-uploader pic">
          ...
          />
          <label for="a1">
            <p v-show="!imageUrl1" class="shangchuan">上传文件</p>
          </label>
        </div>
      </div>
      ...
      <div class="picture">
        ...
        <div class="avatar-uploader pic">
          ...
          />
          <label for="a2">
            <p v-show="!imageUrl2" class="shangchuan">上传文件</p>
          </label>
        </div>
      </div>
      ...
      <div class="picture">
        ...
        <div class="avatar-uploader pic">
          ...
          />
          <label for="a3">
            <p v-show="!imageUrl3" class="shangchuan">上传文件</p>
          </label>
        </div>
      </div>
...
export default {
  ...
  watch: {
    province(val, oldval) {
      this.$axios
        .post("/yulan/areaRegion/getCity.do", this.province)
        .then(res => {
    ...
    city(val, oldval) {
      this.$axios
        .post("/yulan/areaRegion/getCountry.do", this.city)
        .then(res => {
              ...
              this.$axios
                ...
                .then(res => {
                  ...
                  this.citys.forEach(x => {
                    if (x.regionName == bankarr[1]) this.city = x;
                  });
                  if (!!bankarr[2]) {
                    this.$axios
                      .post("/yulan/areaRegion/getCountry.do", this.city)
                      .then(res => {
                        ...
                        this.areas.forEach(x => {
                          if (x.regionName == bankarr[2]) this.area = x;
                        });
                      })
                      .catch(err => {
                        console.log(err);
    ...
    submit() {
      ...
      if (this.addCheck == "no" || this.addCheck == null) {
        ...
        this.$axios
          ...
          .post(
            "/yulan/customerInfo/createYLcontract.do",
            Object.assign(this.obj, { accountLocation: this.accountLocation })
          )
        ...
        this.$axios
          .post(
            "/yulan/customerInfo/updateYLcontract.do",
            Object.assign(this.obj, { accountLocation: this.accountLocation })
          )
          .then(res => {
            if (res.data.code == 0) {
  ...
  computed: {
    accountLocation() {
      if (!this.city.regionName) return this.province.regionName;
