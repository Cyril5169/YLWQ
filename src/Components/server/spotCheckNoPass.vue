 <template>
  <div class="wrapper_inner">
    ...
    >
      ...
      <el-table-column label="未通过项" width="100">
        <template slot-scope="scope">
          <span v-if="scope.row.Y_SPOT_CHECK_STATUS == 'N'" style="color:red;">协议书</span>
          <span v-if="scope.row.SPOT_CHECK_STATUS == 'N'" style="color:red;">资料卡</span>
        </template>
      </el-table-column>
