<template>
    <div class="wrapper">
    <div class="protocol"><serProtocol :cid="this.ccid" :flag='0' @close="close"  @updatePage='updatePage' v-show="showProtocol"></serProtocol></div>
    <ser-search 
    :list='this.showlist' 
    :flag='false'
     :area='area'
...
export default {
  ...
  methods: {
    ...
    close(close){
     ...
     rowClick(row,event,column){//点击行将CID传递
          console.log(row);
           this.ccid = row.CID; 
     },
